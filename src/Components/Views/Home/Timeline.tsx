                        ...
                        {newActiveTab === 3 && (
                            <div>
                                {tabThreeData.map((item, index) => {
                                    return (
                                        <div className="flex xl:flex-nowrap flex-wrap gap-[30px] 2xl:gap-[195px] w-full" key={index}>
                                            <h1 className="text-[#111827] text-2xl font-semibold">{item.mainHeading}</h1>
