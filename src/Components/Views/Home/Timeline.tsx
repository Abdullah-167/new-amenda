        ...
        <div className="py-12">
            <div className=" mx-auto relative ">
                <div className=" pb-10 px-5">
                    <div className=" flex justify-between border-t border-t-[#E5E7EB] border-b border-b-[#E5E7EB] py-5">
                        <div className="flex gap-4  px-5 max-w-[8500px] mb-7 ">
                    ...
                    <div>
                        <div className="mb-10 flex gap-2 items-center cursor-pointer border border-[#111827] px-3 py-2 max-w-[130px] justify-center">
                        ...
                        {DataA.map((item, index) => {
                            return (
                                ...
                                >
                                    ...
                                    >
                                        {activeTab === item.id && (
                                            <div className={`flex overflow-x-auto gap-5 pb-5 relative`}>
                                                {item.data.map((newItem, idx) => {
                                                    return (
                                                        <div key={idx} className="z-[1000] relative">
                                                            ...
                                                            <div className="bg-[#111827] text-[#fff] rounded-full flex justify-center items-center h-[32px] max-w-[32px] mx-auto mb-2">{newItem.number}</div>
                                                            <div className="w-[2px] h-10  mx-auto - -z-[1000]  bg-black inset-x-0">{newItem.line}</div>
                                                            <div className="timt-line-tags relative max-w-[300px] max-h-[300px] overflow-hidden">
                                                                <Image className="min-w-[250px] min-h-[300px] object-cover" src={newItem.mainImg} width={500} height={500} alt="time-line-image" />
                                                                <div className={` ${idx === 1 ? '' : 'bg-black'} bg-opacity-40 absolute w-full h-full top-0`}></div>
                                                                <section className={` absolute w-full h-full top-[180px] pb-1 px-1`}>
                                                                    {newItem.isImgname && (
                                                                        <p className="text-sm text-white pb-2">{newItem.imgName}</p>
                                                                    )}
                                                                    <div className="flex flex-wrap gap-2 ">
                                                                        {newItem.isBtnOne && (
                                                                            <p className='timeline-tatg text-white font-medium cursor-pointer py-[7px] px-1.5 flex justify-center items-center'>{newItem.btnOne}</p>
                                                                        )}
                                                                        {newItem.isBtnTwo && (
                                                                        ...
                                                                        {newItem.isBtnThree && (
                                                                            ...
                                                                            <p className='timeline-tatg text-white font-medium cursor-pointer py-[7px] px-1.5 flex justify-center items-center'>{newItem.btnThree}</p>
                                                                        )}
                                                                        {newItem.isBtnFour && (
                                                                            <p className='timeline-tatg text-white font-medium cursor-pointer py-[7px] px-1.5 flex justify-center items-center'>{newItem.btnFour}</p>
                                                                        )}
                                                                    </div>
                                                                </section>
                                                                <main className="bg-black inset-y-0 bg-opacity-40 absolute w-full h-full top-0 cursor-pointer">
                                                                    <div className="flex gap-1 py-1 max-w-[110px] mt-32 px-2 mx-auto bg-white items-center justify-center">
