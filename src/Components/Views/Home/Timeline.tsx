                ...
                <div className=" pb-10">
                    <div className=" flex 2xl:gap-0 gap-5 justify-between border-t border-t-[#E5E7EB] border-b border-b-[#E5E7EB] py-5 mb-5">
                        ...
                        <div className="flex gap-2 items-center">
                            <svg className=" cursor-pointer" width="19" height="15" viewBox="0 0 19 15" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => handleTextBorder(0)}>
                            ...
                            <svg className=" cursor-pointer" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => handleTextBorder(1)}>
                            ...
                            <svg className=" cursor-pointer" width="19" height="13" viewBox="0 0 19 13" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => handleTextBorder(3)}>
