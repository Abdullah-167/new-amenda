...
const TimeLine = () => {
    ...
    const [activeTab, setActiveTab] = useState(DataA[0]);
    ...
    const [activeText, setActiveText] = useState<boolean | null>(null);


    //    const handleActiveText = (index: number) => {
    //     setActiveText((prevState) => (index === activeTextIndex ? !prevState : true));
    // }
    ...
    const handleTimelineBtn = (index: any) => {
        setNewActiveTab(index)
    }
    ...
    return (
        <div className="py-2 sm:py-12 pr-5">
            <div className=" mx-auto relative ">
                <div className=" pb-10">
                    <div className=" flex 2xl:gap-0 gap-5 justify-between border-t border-t-[#E5E7EB] border-b border-b-[#E5E7EB] py-5 mb-[25px]">
                        <div className="flex gap-4 px-5 xl:overflow-auto overflow-x-scroll">
                            {mainBtn.map((item, index) => {
                                return (
                                    <div
                                        key={index}
                                        className={` py-3 px-3 cursor-pointer ${newActiveTab === item.id ? 'bg-[#111827] text-white' : 'text-[#797F88]'}`}
                                        onClick={() => handleTimelineBtn(item.id)}
                                    >
                                        <h2 className="text-sm whitespace-nowrap">{item.btn}</h2>
                                    </div>
                                );
                            })}
                        </div>
                    ...
                    <div className='sm:px-0 px-5'>
                        {newActiveTab === 5 && (
                            <div className='flex justify-between items-center mb-[26px]'>
                                <div className=" flex gap-2 items-center cursor-pointer border border-[#111827] px-3 py-2 max-w-[130px] justify-center">
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                {text === 0 && (
                                                    <div>
                                                        <div ref={ref} className={`keen-slider sm:flex hidden gap-5 overflow-x-auto  pb-5 relative`}>
                        ...
                        {newActiveTab === 3 && (
                            <div>
                                {tabThreeData.map((item, index) => {
                                    return (
                                        <div className={`flex xl:flex-nowrap flex-wrap gap-[10px] sm:gap-[30px] 2xl:gap-[195px] w-full px-5  overflow-hidden ${index > 0 ? ' border-t border-t-[#E5E7EB] py-[25px]' : ''}`} key={index}>
                                            <div className='sm:hidden  flex justify-between items-center sm:items-start flex-grow'>
                                                <h1 className="text-[#111827] text-sm sm:text-2xl font-semibold">{item.mainHeading}</h1>
                                                <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1.57988 0.523137C1.28903 0.234762 0.817476 0.234762 0.526628 0.523137C0.235779 0.811513 0.235779 1.27906 0.526627 1.56744L4.47061 5.47789C4.76146 5.76627 5.23302 5.76627 5.52386 5.47789C5.81471 5.18952 5.81471 4.72197 5.52386 4.43359L1.57988 0.523137Z" fill="#111827" />
                                                    <path d="M4.4763 4.43257C4.18545 4.72095 4.18545 5.1885 4.4763 5.47687C4.76715 5.76525 5.23871 5.76525 5.52956 5.47687L9.47354 1.56642C9.76439 1.27804 9.76439 0.810494 9.47354 0.522119C9.18269 0.233743 8.71113 0.233742 8.42028 0.522118L4.4763 4.43257Z" fill="#111827" />
                                                </svg>
                                            </div>
                                            <h1 className="text-[#111827] text-sm sm:text-2xl font-semibold sm:block hidden">{item.mainHeading}</h1>

                                            <div className="flex-grow">
                                                {item.data.map((newItem, idx) => {
                                                    return (
                                                        <div className="border-b border-b-[#E5E7EB] mb-[35px]" key={idx}>
                                                            {newItem.isHeading && (
                                                                <h2 className="pb-[30px]">{newItem.heading}</h2>
                                                            )}
                                                            <div className="grid grid-cols-2 gap-5 pt-3">
                                                                {newItem.innerData.map((innerItem, innerIdx) => {
                                                                    return (
                                                                        <div className="mb-[26px]" key={innerIdx}>
                                                                            <div className='flex gap-[7px] pb-2 items-center'>
                                                                                <h2 className="text-[#797F88] text-sm  leading-[0]">{innerItem.heading}</h2>
                                                                                {innerItem.isIcon && (
                                                                                    <span>
                                                                                        {innerItem.icon}
                                                                                    </span>
                                                                            ...
                                                                            <span className="text-[#797F88] text-sm">{innerItem.text}</span>
                                                                        </div>
                                                                    )
                                                                })}
                                                            </div>
                                            ...
                                            >
                                                ...
                                                {text === 0 && (
                                                    <div>
                                                        ...
                                                        <div ref={ref} className={`keen-slider gap-5 overflow-x-auto  pb-5 relative`}>
                                                            <div className=" absolute top-12 border-syl w-full h-1 "></div>
                                                            {item.data.map((newItem, idx) => {
                                                                return (
                                                                    <div key={idx} className="keen-slider__slide z-[1000] relative">
                                                                        ...
                                                                        <div className="time-line-tags relative max-w-[300px] max-h-[300px] overflow-hidden">
                                                                            <div className="w-[2px] h-[15px] absolute mx-auto z-[1000]  bg-black inset-x-0">{newItem.line}</div>
                                                                            <Image className="sm:min-w-[244px] sm:max-w-full max-w-[106px] sm:min-h-[244px] object-cover" src={newItem.mainImg} width={500} height={500} alt="time-line-image" />
                                                                            <div className={` sm:block hidden ${idx === 0 ? 'bg-black' : ''} bg-opacity-30 absolute w-full h-full top-0`}></div>
                                                                            <div>
                                                                                {newItem.isImgname && (
                                                                                    <p className="text-xs  pb-2">{newItem.imgName}</p>
                                                                                )}
                                                                                <div className="flex flex-wrap gap-2 ">
                                                                                    {newItem.isBtnOne && (
                                                                                        <p className=' font-medium bg-[#F3F4F6] cursor-pointer py-[5px] px-1.5 flex justify-center items-center'>{newItem.btnOne}</p>
                                                                                    )}
                                                                                    {newItem.isBtnTwo && (
                                                                                        <p className=' text-black  font-medium bg-[#F3F4F6] cursor-pointer py-[5px] px-1.5 flex justify-center items-center'>{newItem.btnTwo}</p>
                                                                                    )}
                                                                                    {newItem.isBtnThree && (

                                                                                        <p className=' font-medium bg-[#F3F4F6] cursor-pointer py-[5px] px-1.5 flex justify-center items-center'>{newItem.btnThree}</p>
                                                                                    )}
                                                                                    {newItem.isBtnFour && (
                                                                                        <p className=' font-medium bg-[#F3F4F6] cursor-pointer py-[5px] px-1.5 flex justify-center items-center'>{newItem.btnFour}</p>
                                                                                    )}
                                                                                </div>
                                                                            </div>
                                                                            <section className={` sm:block hidden absolute w-full h-full top-[130px] pb-1 px-1`}>
                                                                                {newItem.isImgname && (
                                                                                    <p className="text-sm text-white pb-2">{newItem.imgName}</p>
                                                                                )}
                                                                                <div className="flex flex-wrap gap-2 ">
                                                                            ...
                                                                            <main className="sm:block hidden bg-black inset-y-0 bg-opacity-40 absolute w-full h-full top-0 cursor-pointer">
                                                                                <div className="flex gap-1 py-1 max-w-[120px] mt-[110px] px-2 mx-auto bg-white items-center justify-center">
                                                                                    <svg width="17" height="11" viewBox="0 0 17 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M8.22208 0.729675C4.84042 0.729858 1.71996 2.55531 0.0621249 5.50267C0.0214265 5.57502 3.20479e-05 5.65662 3.59768e-08 5.73963C-3.19759e-05 5.82263 0.0212995 5.90425 0.0619421 5.97663C1.71813 8.92637 4.83914 10.754 8.2219 10.7555C8.22171 10.7555 8.22208 10.7555 8.2219 10.7555C11.6036 10.7542 14.7242 8.92765 16.3809 5.97955C16.4216 5.90719 16.443 5.82558 16.443 5.74257C16.443 5.65957 16.4216 5.57796 16.3809 5.5056C14.7242 2.5575 11.6037 0.731138 8.22208 0.729675C8.2222 0.729675 8.22196 0.729675 8.22208 0.729675ZM8.2219 1.69696C11.1643 1.69806 13.8821 3.23727 15.3992 5.74267C13.8821 8.24788 11.1645 9.78691 8.22245 9.78819C5.2791 9.78709 2.56058 8.24678 1.04367 5.73992C2.56167 3.23544 5.27983 1.69714 8.2219 1.69696ZM8.22153 2.81065C6.60793 2.81065 5.28952 4.12906 5.28952 5.74267C5.28952 7.35609 6.60793 8.6745 8.22153 8.6745C9.83495 8.6745 11.1534 7.35609 11.1534 5.74267C11.1534 4.12906 9.83495 2.81065 8.22153 2.81065ZM8.22153 3.77794C9.31219 3.77794 10.1861 4.65182 10.1861 5.74267C10.1861 6.83333 9.31219 7.70721 8.22153 7.70721C7.13069 7.70721 6.2568 6.83333 6.2568 5.74267C6.2568 4.65182 7.13069 3.77794 8.22153 3.77794Z" fill="black" />
                                                                                    </svg>
                        ...
                        {newActiveTab === 7 && (
                            <div>
                                <div className='flex gap-3 items-center mb-[52px]'>
                ...
                innerData: [
                    {
                        ...
                        icon: (
                            <svg width="11" height="13" viewBox="0 0 11 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2.86081 9.43532C2.69963 9.59453 2.69963 9.83333 2.86081 9.99254C3.02198 10.1517 3.26374 10.1517 3.42491 9.99254L8.74359 4.73881C9.30769 4.18159 9.30769 3.30597 8.74359 2.74876C8.21978 2.23134 7.25275 2.23134 6.72894 2.74876L0.765568 8.6393C0.322344 9.07711 0.0805861 9.63433 0.0805861 10.2313C0.0805861 10.8284 0.322344 11.3856 0.765568 11.8234C1.20879 12.2612 1.77289 12.5 2.37729 12.5C2.98169 12.5 3.54579 12.2612 3.98901 11.8234L10.0733 5.77363C10.6777 5.17662 11 4.4204 11 3.58458C11 2.74876 10.6777 1.99254 10.0733 1.39552C8.86447 0.201493 6.89011 0.201493 5.68132 1.39552L0.120879 6.92786C-0.040293 7.08706 -0.040293 7.32587 0.120879 7.48507C0.282051 7.64428 0.52381 7.64428 0.684982 7.48507L6.24542 1.99254C7.13187 1.11692 8.62271 1.11692 9.50916 1.99254C9.95238 2.43035 10.1941 2.98756 10.1941 3.62438C10.1941 4.26119 9.95238 4.81841 9.50916 5.25622L3.42491 11.2662C2.86081 11.8234 1.89377 11.8234 1.36996 11.2662C1.08791 10.9876 0.92674 10.6294 0.92674 10.2313C0.92674 9.83333 1.08791 9.47512 1.36996 9.19652L7.29304 3.30597C7.5348 3.06716 7.93773 3.06716 8.17949 3.30597C8.42125 3.54478 8.42125 3.94279 8.17949 4.18159L2.86081 9.43532Z" fill="#2286E0" />
                            </svg>
                        ),
                        isIcon: false,
                    },
...
const timeLine = [
    {
        mainImg: '/img1.png',
        newTimeLineText: 'Competition / multi-stage',
        btn: 'More details',
        number: '2',
        month: 'OCTOBER, 2023',
        line: '',
...
const mainBtn = [
    ...
    {
        btn: 'Spezifische Information  ',
        id: 3
    },
    {
        btn: 'Kosten nach DIN 276 ',
        id: 4
    },
    {
        btn: 'Medien ',
