...
const RightBar = () => {
    return (
        <aside>
            <div className=' 2xl:block md:min-w-[400px] w-full h-full bg-[#F3F4F6] p-5 min-h-screen'>
                <div className=' 2xl:max-w-[356px] max-h-[418px] bg-white overflow-y-scroll scroll-bar pb-[20px] pt-[13px] mb-[20px]'>
                ...
                <div className=' 2xl:max-w-[356px] bg-white px-5 max-h-[612px] overflow-y-scroll scroll-bar pb-[20px] pt-[13px]'>
                    <div className="flex items-center justify-between ">
                        ...
                        <p className='border cursor-pointer text-[#797F88] border-[#E5E7EB] py-[7px] px-3 flex justify-center items-center mb-2'>View All Events</p>
                    </div>
                    <div className="">
                                ...
                                <div className="relative overflow-hidden mb-[24px]" key={index}>
                                    ...
                                    <div className="">
                                        {item.data.map((newItem, idx) => {
                                            return (
                                                <div key={idx} className=" flex items-center justify-between overflow-hidden  relative mb-[7px]">
                                                    <div className=" rotate-90 absolute top-12 -left-[110px] border-syl w-full h-1 "></div>
                                                    <div className="bg-[#111827] text-[#fff] rounded-full text-[12px] flex justify-center  z-[100] items-center h-[32px] min-w-[32px] mx-auto mb-2">{newItem.number}</div>
                                                    <div className="flex justify-between items-center px-[10px] py-[10px] border border-[#E5E7EB] max-w-[270px] sm:min-w-[270px] ">
                                                        <div className="">
