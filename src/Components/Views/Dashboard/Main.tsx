    ...
    return (
        <section>
            <div className='max-w-[1200px]'>
                ...
                <div className=' bg-[#F3F4F6] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-[10px]  min-h-[250px] w-full outline-none max-w-[1168px] px-5 py-5 mb-[60px]'>
                    {textData.map((item, index) => {
                        return (
                            ...
                            >
                                ...
                                <p className='text-[#797F88] text-sm pb-[10px]'>{item.text}</p>
